...
INSERT INTO springsecurity.role (id, description, name) VALUES (4, 'Admin role', 'ADMIN');
INSERT INTO springsecurity.role (id, description, name) VALUES (5, 'User role', 'USER');
